!(function (t, e) {
    ...
    var m = { left: 37, up: 38, right: 39, down: 40, enter: 13, esc: 27 };
    function D(t, e, n) {
        return (
    ...
    var b = {
        day: {
            onKeyDown: function (t, e) {
                ...
                n === m.esc ? e.close() : a && (t.preventDefault(), e.setState({ hilightedDate: ((o = e.state.hilightedDate), (r = a), (o = new Date(o)).setDate(o.getDate() + r), o) }));
                var o, r;
            },
            onClick: {
                "dp-day": function (t, e) {
                    e.setState({ selectedDate: new Date(parseInt(t.target.getAttribute("data-date"))) });
                },
                "dp-next": function (t, e) {
                    var n = e.state.hilightedDate;
                    e.setState({ hilightedDate: v(n, 1) });
                },
                ...
                return (
                    ...
                    (function (t, e, n) {
                        ...
                        return (
                            ...
                            (o += n ? " dp-day-disabled" : ""),
                            (o += a ? " dp-day-today" : ""),
                            '<button tabindex="-1" type="button" class="' + (o += " " + i.dateClass(t, r)) + '" data-date="' + t.getTime() + '">' + t.getDate() + "</button>"
                        );
                    }) +
        ...
        year: {
            ...
            onKeyDown: function (t, e) {
                ...
                if (n === m.esc) e.setState({ view: "day" });
                else if (o) {
                    t.preventDefault();
                    var r = i(e.state.hilightedDate, o);
                    e.setState({ hilightedDate: l(r, a.min, a.max) });
                }
            },
            onClick: {
                "dp-year": function (t, e) {
                    e.setState({ hilightedDate: ((n = e.state.hilightedDate), (a = parseInt(t.target.getAttribute("data-year"))), (n = new Date(n)).setFullYear(a), n), view: "day" });
                    var n, a;
                },
            },
        },
        month: {
            onKeyDown: function (t, e) {
                ...
                n === m.esc ? e.setState({ view: "day" }) : a && (t.preventDefault(), e.setState({ hilightedDate: v(e.state.hilightedDate, a, !0) }));
            },
            onClick: {
                "dp-month": function (t, e) {
                    e.setState({ hilightedDate: ((n = e.state.hilightedDate), (a = parseInt(t.target.getAttribute("data-month"))), v(n, a - n.getMonth())), view: "day" });
                    var n, a;
                },
            },
            render: function (t) {
        ...
        var t,
            ...
            c = {
                ...
                open: function () {
                    ...
                    d ||
                        (c.el ||
                            ((c.el = ((t = a), (e = c.containerHTML), ((n = document.createElement("div")).className = t.mode), (n.innerHTML = e), n)),
                                (function (a) {
                                    var t = a.el,
                            ...
                            (i = l(c.computeSelectedDate(), a.min, a.max)),
                ...
                close: function (t) {
                    ...
                    if (c.isVisible()) {
                        ...
                        var a;
                        (d = !0),
                            t && c.shouldFocusOnBlur && ((a = o).focus(), /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && a.blur()),
                            setTimeout(function () {
                                d = !1;
                            }, 100),
                            r("close");
        ...
        return (
            ...
            (x.adjustPosition = function () {
                ...
                (c = x),
                    ...
                    (r = n.offsetHeight),
                    (i = o + t.height + 8),
                    (u = 0 < (s = o - r - 8) && i + r > a + e.innerHeight),
                    (d = u ? s : i),
                    n.classList && (n.classList.toggle("dp-is-above", u), n.classList.toggle("dp-is-below", !u)),
                    (n.style.top = d + "px"),
                    (p = l),
                    (h = f),
                    (v = c.el),
    ...
    function S(t, e, n) {
        return (
            ...
            "dp-modal" === n.mode
                ? ((o = d((a = t), e, n)), (a.readonly = !0), (o.containerHTML += '<a href="#" class="dp-focuser">.</a>'), o)
                : "dp-below" === n.mode
                    ? c(t, e, n)
                    : "dp-permanent" === n.mode
                        ? (((s = d((r = t), e, (i = n))).close = p),
                            (s.destroy = p),
                            (s.updateInput = p),
                            (s.shouldFocusOnRender = i.shouldFocusOnRender),
                            (s.computeSelectedDate = function () {
    ...
    (t.TinyDatePicker = e),
        (t.DateRangePicker = function (t, e) {
            e = e || {};
            var o,
                n = x(),
                ...
                r = { start: void 0, end: void 0 },
                i = F(a.querySelector(".dr-cal-start"), g({}, e.startOpts, { mode: "dp-permanent", dateClass: p })),
                s = F(a.querySelector(".dr-cal-end"), g({}, e.endOpts, { mode: "dp-permanent", hilightedDate: v(i.state.hilightedDate, 1), dateClass: p })),
                u = {
                    statechange: function (t, e) {
                        var n,
                            a = i.state.hilightedDate,
                            o = s.state.hilightedDate;
                        1 != ((n = a), C(o) - C(n)) && (e === i ? s.setState({ hilightedDate: v(e.state.hilightedDate, 1) }) : i.setState({ hilightedDate: v(e.state.hilightedDate, -1) }));
                    },
                    select: function (t, e) {
                        var n = e.state.selectedDate;
                        !r.start || r.end ? l({ start: n, end: void 0 }) : l({ start: n > r.start ? r.start : n, end: n > r.start ? n : r.start });
                    },
                },
                d = { state: r, setState: l, on: n.on, off: n.off };
            var c;
            function l(t) {
